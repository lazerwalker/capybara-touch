...
module TestSessions
  Touch = Capybara::Session.new(:reusable_touch, TestApp)
end

Capybara::SpecHelper.run_specs TestSessions::Touch, "touch"

describe Capybara::Session do
  subject { Capybara::Session.new(:reusable_touch, @app) }
  after { subject.reset! }
